...
Revision ID: 249bc040e0a2
Revises: bd0366df12e9
Create Date: 2025-02-10 19:17:36.641499
...
revision: str = '249bc040e0a2'
down_revision: Union[str, None] = 'bd0366df12e9'
...
def upgrade() -> None:
    ...
    op.alter_column('messages', 'messages', new_column_name='message')
